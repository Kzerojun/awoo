  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="bg-gray-100 p-4 rounded-lg shadow-md overflow-y-auto h-96">
        <h3 className="text-lg font-semibold mb-2 text-m">1. 개인정보 수집 항목 및 목적</h3>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-2 text-m">2. 개인정보 보관 및 보호</h3>
        <p className="text-gray-700 mb-3 text-sm">
          수집된 개인정보는 서비스 제공 목적에 맞게 일정 기간 보관되며, 보관 기간 종료 후 안전하게
          파기됩니다.
        </p>

        <h3 className="text-lg font-semibold mt-4 mb-2 text-m">3. 개인정보 제공 및 공유</h3>
