  ...
  return (
    <div className="bg-white rounded-lg shadow">
      ...
      <div className="p-6 text-gray-800 text-sm space-y-6">
        {activeTab === "info" && (
          <div>
            <h3 className="text-base font-semibold mb-3">적절하개 통장이란?</h3>
            <p>
              산책을 꾸준히 실천 중인 반려인을 위한 2단계 적금 상품입니다. 4개월간의 목표를 달성하면
              마지막 단계로 나아갈 수 있어요.
            </p>
            <ul className="mt-4 list-disc pl-5 text-gray-700 space-y-1">
              <li>가입 기간: 4개월</li>
              <li>2단계는 1단계 달성 시 진입 가능</li>
        ...
        {activeTab === "rate" && (
          <div>
            ...
            <p>
              기본 금리: <strong>2.8%</strong>
            </p>
            <ul className="list-disc pl-5 mt-2 text-gray-700 space-y-1">
              <li>매월 20회 이상 산책 시 → 3단계 진입 가능</li>
              <li>산책 1회 기준: 30분 이상 & 1.5km 이상</li>
              <li>조건 미달 시, 해당 단계까지만 적용</li>
            </ul>
          </div>
        )}
        ...
        {activeTab === "caution" && (
          <div>
            ...
            <p>
              2단계부터는 이전 단계 충족 여부가 확인되어야 가입이 가능합니다. 강아지별로 1개의
              적금만 운영할 수 있습니다.
            </p>
          </div>
        )}
...
export default ProductDetailsStep2;
