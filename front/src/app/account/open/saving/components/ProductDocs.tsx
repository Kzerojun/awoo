...
import PrivacyPage from "@/app/account/open/saving/docs/privacy/page";
import ProductPage from "@/app/account/open/saving/docs/product/page";
import TermsPage from "@/app/account/open/saving/docs/terms/page";
    ...
    <div className="p-4">
      ...
      {modalType && (
        <div className="fixed inset-0 bg-black/20 flex justify-center items-center z-50">
          <div className="bg-white max-w-xl w-[90%] h-[500px] overflow-y-auto rounded-lg shadow-lg relative p-6">
            <button
              onClick={handleClose}
