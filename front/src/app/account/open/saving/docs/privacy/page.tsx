...
const PrivacyPage = () => {
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <div className="bg-gray-100 p-4 rounded-lg shadow-md overflow-y-auto h-[380px]">
        <h3 className="text-m font-semibold mb-2">1. 수집 항목 및 목적</h3>
        ...
        <h3 className="text-m font-semibold mb-2">2. 보관 및 파기</h3>
        <p className="text-gray-700 mb-3 text-sm">
          수집된 정보는 서비스 제공 기간 동안 보관되며, 목적 달성 후에는 안전하게 파기됩니다.
        </p>

        <h3 className="font-semibold mb-2 text-m">3. 제3자 제공</h3>
