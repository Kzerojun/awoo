        ...
        <div className=" flex flex-col items-center justify-center gap-y-3">
          ...
          <div className="w-[90%] flex p-4 flex-col items-center justify-center bg-gray-100">
            ...
            <div className="text-sm mt-2 p-2 flex flex-col items-center justify-center gap-y-1 border border-gray-300">
              <p className="text-center">
                {" "}
                본 서비스는 반려견 산책 인증 및 본인 확인 등을 <br />
                위해 카메라 기능을 이용합니다.
              </p>
              <ul className="list-disc pl-5 space-y-2">
                <li>
          ...
          {/* 위치 정보 수집 권한 이용 동의 */}
          <div className="w-[90%] flex p-4 flex-col items-center justify-center bg-gray-100">
            <h2>위치 정보 수집 권한 이용 및 활용 동의</h2>
            <div className="text-sm mt-2 p-2 flex flex-col items-center justify-center gap-y-1 border border-gray-300">
              <p className="text-center">
                {" "}
                서비스 이용 중 위치 기반 기능 제공을 위해 <br />
                사용자의 위치 정보가 수집될 수 있습니다. <br />
                수집된 위치 정보는 다음과 같은 목적을 위해 <br />
                활용됩니다.
              </p>
              ...
              <p className="text-center">
                위치 정보는 외부에 제공되지 않으며, 이용자의 <br />
                동의 없이 타 용도로 사용되지 않습니다.
              </p>
            </div>
          </div>
        </div>
