...
interface CommonSendConfirmPasswordProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function CommonSendPasswordConfirm({
  isOpen,
  onClose,
  onConfirm,
  amount,
  fee,
}: CommonSendConfirmPasswordProps) {
        ...
        <div className="p-6 bg-white">
          ...
          <div className="mb-4 p-4 bg-gray-50 rounded-lg">
            <p className="text-center text-gray-700">
              총 <span className="font-bold">{amount.toLocaleString()}원</span>을 결제합니다
            </p>
            <p className="text-center text-sm text-gray-500">(일반 결제는 수수료가 없습니다)</p>
          </div>
